...
S3TorrentTornado.prototype = {
	...
	contractID: '@s3torrent.com/tornado;1',
	...
	init : function() {
		...
		Components.utils.import("resource://s3torrent/torrent.js", this);
		this.torrent.init();
		this.set_about();
	},
	//------------------------------------------------------------------------
			...
			'aboutPage' : {
				...
				newChannel: function(aURI, aLoadInfo) {
					...
					try {
						...
						var newURI = ios.newURI("chrome://s3torrent/content/downloads_library.xul", null, null);
						channel = ios.newChannelFromURIWithLoadInfo(newURI, aLoadInfo);
						channel.originalURI = aURI;
					} catch(e) {
						var uri = Services.io.newURI("chrome://s3torrent/content/downloads_library.xul", null, null);
